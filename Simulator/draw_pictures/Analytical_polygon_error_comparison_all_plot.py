# -*- coding: utf-8 -*-
"""Plot feasibility and optimality errors for all analytical-polygon cases."""
...
def load_ap_errors(casename, config_str, m):
    """LoadAnalytical polygonerror data"""
...
def plot_grouped_boxplot(ax, data_list, group_labels, ylabel):
    """Draw grouped boxplots (m=8andm=36Alternate arrangement)

    Args:
        data_list: [m8_case1, m36_case1, m8_case2, m36_case2, ...]
        group_labels: eachcasetags
    """
    ...
    # xAxis labels: displayed in the middle of each groupcasename
...
def plot_all_comparison():
    """Plot all casesAnalytical polygonError comparison chart"""
